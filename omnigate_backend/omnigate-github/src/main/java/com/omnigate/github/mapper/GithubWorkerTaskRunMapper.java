...
/**
 * GitHub Worker 任务执行记录 Mapper。
 */
@Mapper
public interface GithubWorkerTaskRunMapper {
    ...
    @Select("""
            ...
            LIMIT 1
            """)
    GithubTaskRunStatusVO selectStatusById(@Param("id") UUID id);
    ...
    @Select("""
            ...
            LIMIT 1
            """)
    GithubTaskRunStatusVO selectLatestStatusByRootRunId(@Param("rootRunId") UUID rootRunId);
}
